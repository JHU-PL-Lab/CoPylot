...
and convert_directive =
  ...
  | Lamia_ast.Try_except(b1,y,b2,b3) ->
    Lamia_evaluation_ast.Try_except(convert_block b1,y,convert_block b2,convert_block b3)
  ...
  | Lamia_ast.While(y,b,b2) ->
    Lamia_evaluation_ast.While(y,convert_block b,convert_block b2)
