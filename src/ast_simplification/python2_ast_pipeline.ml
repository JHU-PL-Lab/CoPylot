...
let parse_to_normalized (prog: string) (short_names: bool)
...
let parse_to_abstract (prog: string) (short_names: bool)
  :  Python2_abstract_ast.modl =
  let normalized = parse_to_normalized prog short_names in
